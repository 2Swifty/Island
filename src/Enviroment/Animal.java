...
public abstract class Animal extends Entity {
    ...
    private int saturation; // переменная для уровня насышения
    ...
    public int getSaturation() { // вернуть saturation
    ...
    public void setSaturation(int saturation) { // меняем saturation
    ...
    public void eatPlant(Plant plant, World world) {
        if (this.getHerbivore() == true){ // если животное травоядное
            ...
            this.setSaturation((int) newSaturationClamped); //меняем насыщение у текущего
    ...
    public void reproducing(Animal animal) {
        ...
        if (this.getClass() == animal.getClass() && this.getGender() != animal.getGender()) {
            ...
            Animal child = animal.newAnimal();
            reproduce++;
            System.out.println(" Родился новый " + child.getClass().toString());
        }
    }
